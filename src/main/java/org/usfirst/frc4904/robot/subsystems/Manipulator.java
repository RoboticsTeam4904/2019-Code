...
public class Manipulator {
	public static final double INTAKE_SPEED = -1; //TODO: Change speeds
	...
	public Manipulator(SolenoidSubsystem arm, SolenoidSubsystem claws, SolenoidSubsystem ground, SolenoidSubsystem grabber, Motor rollers) {
		this.arm = arm;
		this.claws = claws;
		this.ground = ground;
