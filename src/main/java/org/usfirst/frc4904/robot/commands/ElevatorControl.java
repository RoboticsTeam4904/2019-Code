...
public class ElevatorControl extends RunIf {
	public ElevatorControl(BooleanSupplier joystickDirection) {
		...
		// super(new MotorControl(RobotMap.Component.fourBar.elevator,
		// RobotMap.HumanInput.Operator.joystick,
		// CustomJoystick.Y_AXIS, FourBarElevator.UP_SPEED),
		// new MotorControl(RobotMap.Component.fourBar.elevator,
		// RobotMap.HumanInput.Operator.joystick,
		// CustomJoystick.Y_AXIS, FourBarElevator.DOWN_SPEED),
		// () -> {
