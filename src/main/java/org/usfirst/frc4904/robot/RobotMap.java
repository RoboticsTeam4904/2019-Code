...
// CHANGE IMPORT TO SWITCH BETWEEN ROBOTS (Odysseus.Port or Penelope.Port)
import org.usfirst.frc4904.robot.Penelope.Port;
...
public class RobotMap {
	...
	public RobotMap() {
		...
		Component.elevatorEncoder = new CANTalonEncoder(Component.leftElevatorMotor,
			FourBarElevator.TICK_MULTIPLIER); // TODO: Fix tick multiplier
